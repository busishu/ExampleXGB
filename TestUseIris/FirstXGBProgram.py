...
train_x, val_x, train_y, val_y = train_test_split(iris[ss], iris.label,train_size=0.2,random_state=2016)
...
param = {
    ...
    'num_class':3}
num_round = 200
bst = xgb.train(param, xgbtrain, num_round)
# make prediction
